...
<h1><?php echo $this->getI18NString('create.title', 'create '.$this->getModuleName()) ?></h1>
...
[?php include_partial('<?php echo $this->getModuleName() ?>/create_messages', array('<?php echo $this->getSingularName() ?>' => $<?php echo $this->getSingularName() ?>, 'labels' => $labels)) ?]
[?php include_partial('<?php echo $this->getModuleName() ?>/create_form', array('<?php echo $this->getSingularName() ?>' => $<?php echo $this->getSingularName() ?>, 'labels' => $labels)) ?]
</div>
