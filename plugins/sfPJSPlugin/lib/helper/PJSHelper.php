 ...
 * @version    SVN: $Id: PJSHelper.php 3864 2007-04-24 15:27:52Z fabien $
 */
function use_pjs($uri, $absolute = false, $options = array())
{
  sfPJSHelper::use_pjss($uri, $absolute, $options);
}
...
class sfPJSHelper
{
  static public function use_pjss($uri, $absolute = false, $options = array())
  {
