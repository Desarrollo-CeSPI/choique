...
if (sfConfig::get('app_sf_guard_plugin_routes_register', true) && in_array('sfGuardAuth', sfConfig::get('sf_enabled_modules', array())))
{
  ...
  $r->prependRoute('change_password', '/change_password', array('module' => 'sfGuardUser', 'action' => 'changePassword'));
  $r->prependRoute('must_change_password', '/must_change_password', array('module' => 'sfGuardUser', 'action' => 'mustChangePassword'));
}
