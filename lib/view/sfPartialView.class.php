 ...
 */
class sfPartialView extends choiqueView
{
  /**
  ...
  public function configure()
  {
    ...
    {
      if (is_readable(sfConfig::get('sf_app_template_dir').'/'.$this->getTemplate()))
      {
        $this->setDirectory(sfConfig::get('sf_app_template_dir'));
      }
      else
      {
        $this->setDirectory($this->getGlobalTemplateDir($this->getTemplate()));
      }
    }
    else
    {
