...
<?php echo input_hidden_tag('shortcut[multimedia_id]', $shortcut->getMultimediaId()) ?>
<?php echo input_auto_complete_tag('multimedia_id_search',
                                   $shortcut->getMultimediaId(),
                                   'article/autocompleteMultimedia?_csrf_token='.csrf_token(),
                                   array('size' => '80'),
                                   array('use_style' => true,
                                         'after_update_element' => "function(inputField, selectedItem) { $('shortcut_multimedia_id').value = selectedItem.id; }",
                                         'indicator' => 'searching')) ?>
