...
sfConfig::set('choique_is_backend', true);
sfConfig::set('choique_frontend_web_dir', SF_ROOT_DIR.'/web-frontend');
sfConfig::set('sf_web_dir', SF_ROOT_DIR.'/web-backend');
...
sfConfig::set('cms_longdesc_images_dir', sfConfig::get('sf_upload_dir').'/assets/longdesc');
